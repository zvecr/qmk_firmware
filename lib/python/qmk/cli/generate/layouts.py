...
def generate_layouts(cli):
    ...
    if 'matrix_pins' in kb_info_json:
        if 'custom' in kb_info_json['matrix_pins'] or 'custom_lite' in kb_info_json['matrix_pins']:
            col_num = kb_info_json['matrix_size'].get('cols', 0)
            row_num = kb_info_json['matrix_size'].get('rows', 0)
        elif 'direct' in kb_info_json['matrix_pins']:
