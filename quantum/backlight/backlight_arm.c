...
static void breathing_reset(uint8_t level);
#else
#    define breathing_callback NULL
#endif
...
static void breathing_reset(uint8_t level) { level ? breathing_max() : breathing_min(); }
