...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_60_ansi(
        ...
        L_T_BR,  L_PSD,   L_BRI,   L_PSI,   L_EDG_I, _______, KC_PSCR, KC_SCRL, KC_PAUS, _______, KC_UP,   _______, _______, U_T_AGCR,\
        L_T_PTD, L_PTP,   L_BRD,   L_PTN,   L_EDG_D, _______, KC_INS,  KC_HOME, KC_PGUP, KC_LEFT, KC_DOWN, KC_RGHT,           _______, \
        _______, L_T_MD,  L_T_ONF, _______, L_EDG_M, QK_BOOT, NK_TOGG, KC_END,  KC_PGDN, KC_VOLU, KC_VOLD,                   _______, \
        _______, _______, _______,                   DBG_TOG,                                     _______, KC_MUTE, _______,  _______ \
    ),
    /*
    [X] = LAYOUT_60_ansi(	
