...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_1800_ansi(
        ...
        RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW,_______, QK_BOOT, NK_TOGG, DEBUG,   _______, _______, _______, _______,          _______,          _______, _______, _______, _______,
        _______, _______, _______,                   DEBUG,                              KC_APP,  _______,          _______, _______, _______,          _______, _______
    )
};
