...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_1800_ansi(
        ...
        _______, L_T_MD,  L_T_ONF, _______, L_EDG_M, MD_BOOT, NK_TOGG, _______, _______, _______, _______, _______,          _______,          _______, _______, _______, _______, \
        _______, _______, _______,                   DBG_FAC,                            KC_APP,  _______,          _______, _______, _______,          _______, _______           \
    ),
    /*
    [X] = LAYOUT_1800_ansi(
